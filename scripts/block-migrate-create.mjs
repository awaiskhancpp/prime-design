...
There are 40 migrations but only 25 schema snapshots, and the newest snapshot
(20260914_180701_video_story_fields.json) predates all 17 hand-written
migrations. \`migrate:create\` diffs the Payload config against that stale
snapshot, so it would emit SQL that DROPS the tables and columns those 17
...
17 snapshot-less migrations are in CLAUDE.md -> Migrations.${OFF}
`)
