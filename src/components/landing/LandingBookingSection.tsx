...
export function LandingBookingSection({ heading = 'Request an Estimate Appointment' }: { heading?: string }) {
  const [open, setOpen] = useState(false)
  return (
    <Section className="bg-paper">
      <div className="mx-auto max-w-3xl text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brass">Schedule a consultation</p>
